...
R, Python, and MATLAB. This phenomenon might be explained by the pronounced use
of C/C++ in statistical genetic, where calling ARPACK and PROPACK are relatively
...
\begin{table}
    \centering
    \caption{List of software used for principal components analysis by genomics
    scientists and numerical linear algebraists. $^*$: available in EIGENSOFT~\cite{Patterson2006}.
    \label{tab:sw}}
    \begin{tabular}{|c|c|c|c|}
       \hline
        Software         & Reference & Algorithm                              & Used in genomics \\ \hline
        smartpca$^*$ & \cite{Patterson2006} & Householder bidiagonalization (LAPACK) & \cmark \\ \hline
        FastPCA$^*$ & \cite{Galinsky2016} & Subspace iteration        & \cmark \\ \hline
        FlashPCA         & \cite{abraham2014fast} & Subspace iteration      & \cmark \\ \hline
        ARPACK           & \cite{Lehoucq1996} & Lanczos tridiagonalization  & \xmark \\ \hline
        PROPACK          & \cite{Larsen1998} & Lanczos bidiagonalization    & \xmark \\ \hline
        SLEPc            & \cite{Hernandez2008} & Lanczos bidiagonalization & \xmark \\ \hline
