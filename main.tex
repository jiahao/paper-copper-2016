...
\begin{table}
    ...
    \begin{tabular}{|c|c|c|}
\hline
        Software         & Algorithm                              & Used in genomics \\ \hline
        EIGENSOFT/LAPACK & Householder bidiagonalization          & \cmark \\ \hline
        FlashPCA         & Subspace iteration                     & \cmark \\ \hline
        ARPACK           & Lanczos tridiagonalization on $X^TX$   & \xmark \\ \hline
        PROPACK          & Lanczos bidiagonalization              & \xmark \\ \hline
        SLEPc            & Lanczos bidiagonalization              & \xmark \\ \hline
    \end{tabular}
\end{table}
