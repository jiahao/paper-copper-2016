...
\begin{table}
    ...
    scientists and numerical linear algebraists. $^*$: available in EIGENSOFT~\cite{Patterson2006}. $^\dagger$: uses dense LAPACK routines.
    \label{tab:sw}}
    \begin{tabular}{cccc}
       \hline
...
All timings were done on a machine with two Intel(R) Xeon(R) CPU E5-2697 v2 @ 2.70GHz processors which each have 12 cores and the machine has 230GB of memory.
